...
class LoggerTests: XCTestCase {
    func testLogFromMain() {
        let logger = Logger(try! OSLog(category: "Tests", bundle: Bundle(for: LoggerTests.self)))
    ...
    func testNoBundleIdentifier() {
        ...
        XCTAssertThrowsError(try OSLog(category: "Failing", bundle: testBundle), "Should have failed because of missing bundle identifier") { error in
