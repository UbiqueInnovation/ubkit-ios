...
public extension UBURLDataTask {
    ...
    /// - Returns: `TaskResult`. Access data by result.data (throwing!)
    ///
    static func loadOnce<T: Sendable, E: UBURLDataTaskErrorBody>(request: UBURLRequest, decoder: UBURLDataTaskDecoder<T>, errorDecoder: UBURLDataTaskDecoder<E>, ignoreCache: Bool = false, taskConfig: TaskConfig = TaskConfig()) async -> TaskResult<T> {
        let task = UBURLDataTask(request: request)
    ...
    ///
    @discardableResult
    static func loadOnce<T: Sendable, E: UBURLDataTaskErrorBody>(url: URL, decoder: UBURLDataTaskDecoder<T>, errorDecoder: UBURLDataTaskDecoder<E>, ignoreCache: Bool = false, taskConfig: TaskConfig = TaskConfig()) async -> TaskResult<T> {
    ...
    ///   - errorDecoder: The decoder for the error in case of a failed request
    /// - Returns: A throwing stream of decoded result object with metadata
    func startStream<T: Sendable, E: UBURLDataTaskErrorBody>(decoder: UBURLDataTaskDecoder<T>, errorDecoder: UBURLDataTaskDecoder<E>) -> AsyncThrowingStream<(T, MetaData), Error> {
...
public extension UBURLDataTask.TaskConfig {
    ...
    ///
    @discardableResult
    func loadOnce<T: Sendable, E: UBURLDataTaskErrorBody>(request: UBURLRequest, decoder: UBURLDataTaskDecoder<T>, errorDecoder: UBURLDataTaskDecoder<E>, ignoreCache: Bool = false) async -> UBURLDataTask.TaskResult<T> {
    ...
    ///
    @discardableResult
    func loadOnce<T: Sendable, E: UBURLDataTaskErrorBody>(url: URL, decoder: UBURLDataTaskDecoder<T>, errorDecoder: UBURLDataTaskDecoder<E>, ignoreCache: Bool = false) async -> UBURLDataTask.TaskResult<T> {
