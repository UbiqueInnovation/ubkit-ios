...
public final class Localization: Codable {
    ...
    public init(locale: Locale = .current, baseBundle: Bundle = .main, notificationCenter: NotificationCenter = .default) {
        self.locale = locale
        bundle = Bundle(locale: locale, in: baseBundle)
...
extension Localization {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(bundle?.bundlePath, forKey: .bundlePath)
    }
}
...
extension Localization: CustomDebugStringConvertible {
    ...
    public var debugDescription: String {
        return "\(Localization.self) (\(locale.identifier)) [\(bundle?.bundlePath ?? "No bundle")]"
    }
}
